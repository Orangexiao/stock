...
angular.module('app')
    .controller('AppCtrl', ['$scope', '$rootScope', '$translate', '$localStorage', '$window', '$state', 'toaster','FunctionInfoService',
        function ($scope, $rootScope, $translate, $localStorage, $window, $state, toaster,FunctionInfoService) {
